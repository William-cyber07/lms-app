...
import {
  ...
  where, onSnapshot, updateDoc, arrayUnion, getDocs, setDoc, serverTimestamp
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-auto lg:overflow-hidden">
        ...
        <div className="w-full lg:w-72 bg-gray-900 border-b lg:border-b-0 lg:border-r border-gray-800 flex flex-col">
          ...
          {announcements.length > 0 && (
            <div className="p-3 border-t border-gray-800">
              ...
              {announcements.map((a) => (
                <div key={a.id} className="bg-gray-800 rounded-lg px-3 py-2 mb-2">
        ...
        {/* Main content */}
        <div className="flex-1 lg:overflow-y-auto p-4 sm:p-8">
          {activeLesson ? (
            <>
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                <button
                  ...
                  className="bg-purple-700 hover:bg-purple-600 text-white px-6 py-2.5 rounded-lg transition font-semibold"
                >
                  🤖 Take AI Quiz
                </button>
                <button
                  onClick={() => navigate(`/student/discussion/${activeLesson.id}`)}
                  className="bg-blue-700 hover:bg-blue-600 text-white px-6 py-2.5 rounded-lg transition font-semibold"
                >
                  💬 Discussion
                </button>
              </div>
